...
const mens_clothing = document.getElementById('men\'s clothing');
...
fetch('https://fakestoreapi.com/products/category/men\'s clothing')
    ...
    .then((data) => {
        ...
        mens_clothing.innerHTML = cards.join('')
    })
...
const womens_clothing = document.getElementById('women\'s clothing');
...
fetch('https://fakestoreapi.com/products/category/women\'s clothing')
    ...
    .then((data) => {
        ...
        womens_clothing.innerHTML = cards.join('')
    })
